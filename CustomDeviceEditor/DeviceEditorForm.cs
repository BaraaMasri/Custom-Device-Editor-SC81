...
namespace CustomDeviceEditor
{
    ...
    public class DeviceEditorForm : DialogForm
    {
        ...
        public System.Collections.ArrayList Controls
        {
            get
            {
                return (System.Collections.ArrayList)Context.ClientPage.ServerProperties["Controls"];
            }
            set
            {
        ...
        private void RenderPlaceholders(DeviceDefinition deviceDefinition)
        {
            ...
            System.Collections.ArrayList placeholders = deviceDefinition.Placeholders;
            if (placeholders == null)
            {
                return;
            }
        ...
        {
            Assert.ArgumentNotNull(deviceDefinition, "deviceDefinition");
            System.Collections.ArrayList renderings = deviceDefinition.Renderings;
            if (renderings == null)
            {
                return;
            }
